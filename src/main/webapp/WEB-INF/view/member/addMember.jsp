    ...
    <div class="pricing">
      <div class="container">
       ...
       <div class="d-flex justify-content-center" data-aos="zoom-in">
            ...
            <br>
              <h4>Sign up</h4>
              <h4><span>It's nice to be with you.</span></h4>
            <form action="${pageContext.request.contextPath}/member/addMember" method="post" id="registerForm" role="form" class="php-email-form">
             
              <div>
                <input type="text" class="form-control" name="memberId" id="memberId" placeholder="ID" width="500px">
              </div>
              <div>
                <input type="text" class="form-control mt-2" name="memberName" id="memberName" placeholder="Name" width="500px">
              </div>
              <div>
              ...
              <div class="btn-wrap mt-3">
                <div name="submitBtn" id="submitBtn" class="btn-buy">Create an account</div>
              </div>
              <br>
            </form>
