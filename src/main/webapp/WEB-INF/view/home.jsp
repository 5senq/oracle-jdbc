...
<c:if test="${loginMember == null }">
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      ...
      <h2>I support your day. We hope your day is happy.</h2>
      <a href="${pageContext.request.contextPath}/member/login" class="btn-get-started scrollto">Log in</a>
      <a href="${pageContext.request.contextPath}/member/addMember" class="btn-get-started scrollto">create an account</a>
    </div>
  </section><!-- End Hero -->
